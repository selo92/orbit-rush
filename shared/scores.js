...
export const GAME_ENUM = new Set(['rush', 'mirror', 'drift', 'pulse']);
export const DEFAULT_GAME = 'rush';
export const GAME_ERROR = 'Invalid game (rush|mirror|drift|pulse)';
 ...
 * game: 'rush' | 'mirror' | 'drift' | 'pulse' (missing = rush). Boards are never mixed.
 */
